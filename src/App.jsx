...
function App() {
  ...
  useEffect(() => {
    ...
    const handleChange = (event) => {
      setIsUiCollapsed(event.matches)
    }

    setIsUiCollapsed(mediaQuery.matches)
  ...
  return (
    <main className="app">
      ...
      <div className={`card ${isUiCollapsed ? 'card--collapsed' : ''}`}>
        <header className="card__header">
          ...
          <div className="card__actions">
            ...
            >
              {isUiCollapsed ? 'Afficher les contrôles' : "Afficher l'anim"}
            </button>
        ...
        <div className={`card__content ${isUiCollapsed ? 'card__content--hidden' : ''}`}>
